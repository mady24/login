...
class ThirdStep2 extends React.Component {
    ...
    return (
      ...
      >
        ...
        <Image
          ...
          source={require('../image/thirdstep.png')}
        />
      <View style={{flexDirection: 'row', marginTop: '5%', alignItems: 'center'}}>
        ...
        <View style={{flexDirection: 'column', marginTop: '10%', alignItems: 'center'}}>
            ...
            >
            Saisissez un montant et générez
            </Text>
            <Text
              style={{
                marginLeft: '2%',
